...
$$
\mathrm{xd}_{i} = \mathrm{ad}_{i} \cdot \prod_{lc \in \mathcal{D}_{lc}} {\mathrm{l}_{i,lc}}^{alphl_lc,i} \cdot {\mathrm{k}_{i}}^{1-sum_lc∈{labor1,labor2,labor3}(alphl_lc,i)}
$$
...
$$
omega = \prod_{i \in \mathcal{D}_{i}} {\mathrm{cd}_{i}}^{alpha_i}
$$
