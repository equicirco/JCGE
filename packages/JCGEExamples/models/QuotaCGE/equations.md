...
$$
\mathrm{M}_{i} = ({\mathrm{gamma}_{i}}^{eta_i} \cdot \mathrm{delta\_m}_{i} \cdot \mathrm{pq}_{i} / (1 + \mathrm{chi}_{i} + \mathrm{tau\_m}_{i}) \cdot \mathrm{pm}_{i})^{1/(1-eta_i)} \cdot \mathrm{Q}_{i}
$$
