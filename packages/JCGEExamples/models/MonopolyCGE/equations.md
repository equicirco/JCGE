...
- `armington.eqD[BRD]` D[i] = gamma[i]^eta[i] * delta_d[i] * pq[i] / pd_scale[i] * pd[i]^1.0 / 1.0 + -eta[i] * Q[i]
...
- `armington.eqD[MLK]` D[i] = gamma[i]^eta[i] * delta_d[i] * pq[i] / pd_scale[i] * pd[i]^1.0 / 1.0 + -eta[i] * Q[i]
...
- `rent.eqRT[BRD]` RT[i] = 1.0 + -eta[i] / eta[i] * pd[i] * D[i]
- `rent.eqRT[MLK]` RT[i] = 1.0 + -eta[i] / eta[i] * pd[i] * D[i]
